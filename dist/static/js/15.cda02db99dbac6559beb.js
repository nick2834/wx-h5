...
var update = __webpack_require__(486)("9f89afcc", content, true);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vux_src_components_scroller_index_vue__ = __webpack_require__(553);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    getDetails(data) {
      __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_api__["A" /* guideDetail */])(data).then(res => {
        if (res.code === 0) {
    ...
    getNums(data) {
      __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_api__["B" /* playNums */])(data).then(res => {
        console.log(res);
      });
    },
    onScroll() {},
...
//# sourceMappingURL=15.cda02db99dbac6559beb.js.map