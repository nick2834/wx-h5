...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vux_src_components_scroller_index_vue__ = __webpack_require__(525);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    getDetails(data) {
      __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_api__["k" /* guideDetail */])(data).then(res => {
        if (res.code === 0) {
    ...
    getNums(data) {
      __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_api__["l" /* playNums */])(data).then(res => {
        console.log(res);
      });
    },
    onScroll() {},
...
// module
exports.push([module.i, ".video_container[data-v-354ca3e7]{height:200px;width:100%;background:#31a8e2}.other_container[data-v-354ca3e7]{width:100%;margin:0 auto;padding:0 1rem;box-sizing:border-box;display:block}.other_container .control_box[data-v-354ca3e7]{width:100%;overflow:hidden;position:relative;height:3rem;line-height:3rem;display:-ms-flexbox;display:flex;-ms-flex-pack:justify;justify-content:space-between}.other_container .control_box .iconfont[data-v-354ca3e7]{font-size:1.2rem}.description[data-v-354ca3e7]{padding-bottom:1rem;border-bottom:1px solid #e9e8e8}.description .title[data-v-354ca3e7]{font-weight:700;font-size:1rem;line-height:3rem;color:#343434}.description .desc[data-v-354ca3e7]{font-size:.8rem;color:#575757;line-height:1.5rem;white-space:pre-wrap}.more .title[data-v-354ca3e7]{font-weight:700;font-size:1rem;line-height:3rem;color:#343434}.more .list .items[data-v-354ca3e7]{float:left;margin-right:1rem}.more .list .items[data-v-354ca3e7]:last-child{margin-right:0}.more .list .items img[data-v-354ca3e7]{height:80px}.more .list .items p[data-v-354ca3e7]{line-height:2rem;font-size:.8rem;text-align:center}", "", {"version":3,"sources":["F:/WXH5/src/pages/Index/guideDetail.vue"],"names":[],"mappings":"AACA,kCACE,aAAc,AACd,WAAY,AACZ,kBAAoB,CACrB,AACD,kCACE,WAAY,AACZ,cAAe,AACf,eAAgB,AAChB,sBAAuB,AACvB,aAAe,CAChB,AACD,+CACE,WAAY,AACZ,gBAAiB,AACjB,kBAAmB,AACnB,YAAa,AACb,iBAAkB,AAClB,oBAAqB,AACrB,aAAc,AACd,sBAAuB,AACnB,6BAA+B,CACpC,AACD,yDACE,gBAAkB,CACnB,AACD,8BACE,oBAAqB,AACrB,+BAAiC,CAClC,AACD,qCACE,gBAAkB,AAClB,eAAgB,AAChB,iBAAkB,AAClB,aAAe,CAChB,AACD,oCACE,gBAAiB,AACjB,cAAe,AACf,mBAAoB,AACpB,oBAAsB,CACvB,AACD,8BACE,gBAAkB,AAClB,eAAgB,AAChB,iBAAkB,AAClB,aAAe,CAChB,AACD,oCACE,WAAY,AACZ,iBAAmB,CACpB,AACD,+CACE,cAAgB,CACjB,AACD,wCACE,WAAa,CACd,AACD,sCACE,iBAAkB,AAClB,gBAAiB,AACjB,iBAAmB,CACpB","file":"guideDetail.vue","sourcesContent":["\n.video_container[data-v-354ca3e7] {\n  height: 200px;\n  width: 100%;\n  background: #31a8e2;\n}\n.other_container[data-v-354ca3e7] {\n  width: 100%;\n  margin: 0 auto;\n  padding: 0 1rem;\n  box-sizing: border-box;\n  display: block;\n}\n.other_container .control_box[data-v-354ca3e7] {\n  width: 100%;\n  overflow: hidden;\n  position: relative;\n  height: 3rem;\n  line-height: 3rem;\n  display: -ms-flexbox;\n  display: flex;\n  -ms-flex-pack: justify;\n      justify-content: space-between;\n}\n.other_container .control_box .iconfont[data-v-354ca3e7] {\n  font-size: 1.2rem;\n}\n.description[data-v-354ca3e7] {\n  padding-bottom: 1rem;\n  border-bottom: 1px solid #E9E8E8;\n}\n.description .title[data-v-354ca3e7] {\n  font-weight: bold;\n  font-size: 1rem;\n  line-height: 3rem;\n  color: #343434;\n}\n.description .desc[data-v-354ca3e7] {\n  font-size: .8rem;\n  color: #575757;\n  line-height: 1.5rem;\n  white-space: pre-wrap;\n}\n.more .title[data-v-354ca3e7] {\n  font-weight: bold;\n  font-size: 1rem;\n  line-height: 3rem;\n  color: #343434;\n}\n.more .list .items[data-v-354ca3e7] {\n  float: left;\n  margin-right: 1rem;\n}\n.more .list .items[data-v-354ca3e7]:last-child {\n  margin-right: 0;\n}\n.more .list .items img[data-v-354ca3e7] {\n  height: 80px;\n}\n.more .list .items p[data-v-354ca3e7] {\n  line-height: 2rem;\n  font-size: .8rem;\n  text-align: center;\n}\n"],"sourceRoot":""}]);
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(479)("9f89afcc", content, true);
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', [(_vm.details.type == 'image') ? _c('div', _vm._l((_vm.details.listsrc), function(item, index) {
    return _c('img', {
    ...
    staticClass: "other_container"
  }, [_c('div', {
    staticClass: "control_box"
  }, [_c('i', {
    staticClass: "iconfont icon-play"
  }, [_vm._v(_vm._s(_vm.details.playback))]), _vm._v(" "), _c('i', {
    staticClass: "iconfont icon-fenxiang"
  })]), _vm._v(" "), _c('div', {
    staticClass: "description"
  }, [_c('h4', {
    staticClass: "title"
  }, [_vm._v(_vm._s(_vm.details.title))]), _vm._v(" "), _c('div', {
    staticClass: "desc",
    domProps: {
      "innerHTML": _vm._s(_vm.details.info)
    }
  })]), _vm._v(" "), _c('div', {
    staticClass: "more"
  }, [_c('h4', {
    staticClass: "title"
  }, [_vm._v("更多指引")]), _vm._v(" "), _c('div', {
...
//# sourceMappingURL=15.dfeadbecce0d57b17000.js.map