...
var update = __webpack_require__(486)("719d0d34", content, true);
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    directives: [{
      name: "model",
      rawName: "v-model",
      value: (_vm.form.identicode),
      expression: "form.identicode"
    }],
    attrs: {
      "type": "text",
      "name": "",
    ...
    on: {
      "input": function($event) {
        if ($event.target.composing) { return; }
        _vm.$set(_vm.form, "identicode", $event.target.value)
      }
    }
  }), _vm._v(" "), _c('div', {
  ...
  }, [_vm._v("智淘助手用户注册协议")])], 1), _vm._v(" "), _c('x-button', {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vux_src_components_countdown_index_vue__ = __webpack_require__(1377);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vux_src_components_countdown_index_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_vux_src_components_countdown_index_vue__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_vux_src_components_x_button_index_vue__ = __webpack_require__(684);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_vux_src_components_toast_index_vue__ = __webpack_require__(683);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_vux_src_components_toast_index_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3_vux_src_components_toast_index_vue__);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  components: {
    Countdown: __WEBPACK_IMPORTED_MODULE_1_vux_src_components_countdown_index_vue___default.a,
    XButton: __WEBPACK_IMPORTED_MODULE_2_vux_src_components_x_button_index_vue___default.a,
    Toast: __WEBPACK_IMPORTED_MODULE_3_vux_src_components_toast_index_vue___default.a
  },
  methods: {
    getUserInfo(data) {
    ...
    getCode(e) {
      ...
      __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_4_api__["k" /* IdentityCode */])(data).then(res => {
        console.log(res);
        if (res.code === 0) {
          this.$Toast(res.msg);
        } else {
    ...
    handleSubmit(e) {
      ...
      __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_4_api__["l" /* Register */])(data).then(res => {
        console.log(res);
        if (res.code === 0) {
          ...
          if (type === 'zhuce') {
            ...
            that.$router.replace(__WEBPACK_IMPORTED_MODULE_5_good_storage___default.a.session.get('detailPath'));
          } else {
...
// module
exports.push([module.i, ".register-box[data-v-5813c816]{position:fixed;top:0;left:0;right:0;bottom:0;background:#fff;display:block;padding:5rem 1rem 0}.register-box input[data-v-5813c816]{width:100%;height:3rem;background:#f6f6f6;border-radius:5px;margin-bottom:25px;padding-left:10px;box-sizing:border-box}.register-box input[name=phone][data-v-5813c816]{padding-right:95px}.register-box .indentity-code[data-v-5813c816]{position:relative}.register-box .indentity-code button[data-v-5813c816]{position:absolute;right:10px;top:.5rem;background:#fff;font-size:.8rem;border:1px solid #eaeaea;height:2rem}.register-box .agreement[data-v-5813c816]{font-size:.8rem;color:#888}.register-box .agreement a[data-v-5813c816]{color:#317df4;text-decoration:underline}.register-box .submitBtn[data-v-5813c816]{margin-top:35px}", "", {"version":3,"sources":["F:/WXH5/src/pages/Mine/register.vue"],"names":[],"mappings":"AACA,+BACE,eAAgB,AAChB,MAAO,AACP,OAAQ,AACR,QAAS,AACT,SAAU,AACV,gBAAoB,AACpB,cAAe,AACf,mBAAqB,CACtB,AACD,qCACE,WAAY,AACZ,YAAa,AACb,mBAAoB,AACpB,kBAAmB,AACnB,mBAAoB,AACpB,kBAAmB,AACnB,qBAAuB,CACxB,AACD,iDACE,kBAAoB,CACrB,AACD,+CACE,iBAAmB,CACpB,AACD,sDACE,kBAAmB,AACnB,WAAY,AACZ,UAAW,AACX,gBAAoB,AACpB,gBAAiB,AACjB,yBAA0B,AAC1B,WAAa,CACd,AACD,0CACE,gBAAiB,AACjB,UAAe,CAChB,AACD,4CACE,cAAe,AACf,yBAA2B,CAC5B,AACD,0CACE,eAAiB,CAClB","file":"register.vue","sourcesContent":["\n.register-box[data-v-5813c816] {\n  position: fixed;\n  top: 0;\n  left: 0;\n  right: 0;\n  bottom: 0;\n  background: #ffffff;\n  display: block;\n  padding: 5rem 1rem 0;\n}\n.register-box input[data-v-5813c816] {\n  width: 100%;\n  height: 3rem;\n  background: #f6f6f6;\n  border-radius: 5px;\n  margin-bottom: 25px;\n  padding-left: 10px;\n  box-sizing: border-box;\n}\n.register-box input[name='phone'][data-v-5813c816] {\n  padding-right: 95px;\n}\n.register-box .indentity-code[data-v-5813c816] {\n  position: relative;\n}\n.register-box .indentity-code button[data-v-5813c816] {\n  position: absolute;\n  right: 10px;\n  top: .5rem;\n  background: #ffffff;\n  font-size: .8rem;\n  border: 1px solid #eaeaea;\n  height: 2rem;\n}\n.register-box .agreement[data-v-5813c816] {\n  font-size: .8rem;\n  color: #888888;\n}\n.register-box .agreement a[data-v-5813c816] {\n  color: #317df4;\n  text-decoration: underline;\n}\n.register-box .submitBtn[data-v-5813c816] {\n  margin-top: 35px;\n}\n"],"sourceRoot":""}]);
...
//# sourceMappingURL=17.21247acf1c4b355a88aa.js.map