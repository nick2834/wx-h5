          ...
          <div>
            <div class="userInfo" v-if="tabDefault === 1" v-cloak>
              <div class="user user_l clearfix">
                <img class="img-responsive" src="../../assets/images/default.png" alt="">
                <div class="user_box">
                  <span>Nickname</span>
                  <span>1000+</span>
                </div>
              </div>
              <div class="user user_r">0.00</div>
            </div>
            ...
            <div class="rank_scroll_box">
              ...
              <div class="rank_scroll_list">
                <div class="item_list" v-for="(item,index) in 10" :key="index">
                  ...
                  <div class="items">
                    <img class="img-responsive" src="../../assets/images/default.png" alt="">
                    <span class="rank_username">皮皮虾</span>
                    <span class="rank_numbers">18965.77</span>
                  </div>
                </div>
              </div>
            </div>
