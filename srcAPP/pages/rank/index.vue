<template>
  <div class="rank_box page-content">
    ...
    <div class="rank_content" :style="{'top':tabTopHeight}">
      <div class="tab_box">
...
export default {
  ...
  mounted () {
    ...
    that.$nextTick(() => {
      ...
      that.scrollHeight = (that.clientHeight  - that.$refs.cascade.offsetHeight - 143) + 'px'
      that.tabTopHeight = (that.$refs.cascade.offsetHeight + 44 ) + 'px'
